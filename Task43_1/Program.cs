...
{
    System.Console.Write(message); //ввести сообщение
    string value = Console.ReadLine(); //считает с консоли строку
...
double[] FindCoords(double[] lineData1, double[] lineData2)
{
    ...
    coord[Y_COORD] = lineData1[CONSTANT] * coord[X_COORD] + lineData2[CONSTANT];
    return coord;
}
...
bool ValidateLines(double[] lineData1, double[] lineData2)
{
    if (lineData1[COEFFICIENT] == lineData2[COEFFICIENT])
    {
        ...
        {
            Console.WriteLine("Прямые своподают");
            return false;
        }
        else
        {
